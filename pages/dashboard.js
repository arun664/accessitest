    ...
    <div className="p-6">
        ...
        <div className="ml-auto">
          {loggedIn ? (
            <button
              ...
              className="mt-4 px-4 py-2 bg-blue-300 text-black dark:bg-blue-500 dark:hover:bg-blue-300 rounded hover:bg-blue-700 disabled:bg-gray-400"
              disabled={loading}
            >
            ...
            <button
              ...
              className="mt-4 px-4 py-2  bg-blue-300 text-black dark:bg-blue-500 dark:hover:bg-blue-300 rounded hover:bg-blue-700"
            >
      ...
      <div className="mt-6 p-4 bg-gray-100 rounded dark:bg-gray-800">
        ...
        <button
          ...
          className="mt-4 px-4 py-2 bg-orange-300 text-black dark:bg-orange-700 dark:hover:bg-orange-300 rounded hover:bg-orange-700"
        >
